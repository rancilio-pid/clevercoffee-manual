...
In General: cut the cables to a length of 60 cm and trim them to the correct length during the assembly.


Preparations:
* Flash the software on the NodeMCU (make sure Wifi is working)
* set up and connect to Blynk

Timeline:
* PID Only ca. 3 h
* Full expansion: additional 2-3 h

## Disassembly

FIrst, you have to disassembly your machine, here is a [link to the description](http://rancilio-pid.de/bauberichte/baubericht-demontage/).

## PID only

### Swap thermostat against temperature sensor
